...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OperatorFoundation/Shapeshifter-Swift-Transports.git", from: "0.3.0"),
    ...
    targets: [
        ...
        .target(
            name: "ProteanSwiftServer",
            dependencies: ["Protean", "Transport"]),
        .testTarget(
            name: "ProteanSwiftServerTests",
            dependencies: ["ProteanSwiftServer", "INI"])
    ]
)
